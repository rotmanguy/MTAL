...
@TextFieldEmbedder.register("hcdp-embedder")
class HCDPTextFieldEmbedder(TextFieldEmbedder):
    """
    ...
    def __init__(self,
        ...
        super(HCDPTextFieldEmbedder, self).__init__()
    ...
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'UdifyTextFieldEmbedder':  # type: ignore
        ...
        if token_embedder_params is not None:
            ...
            token_embedders = {}
            for name, subparams in token_embedder_params.items():
                token_embedders[name] = TokenEmbedder.from_params(subparams, vocab=vocab)
