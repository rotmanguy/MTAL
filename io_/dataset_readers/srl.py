...
x = ConllCorefReader(max_span_width=5)
path = os.path.join('/data/home/grotman/Data/Datasets/Ontonotes/conll-formatted-ontonotes-5.0-12/conll-formatted-ontonotes-5.0/data/train/data/english/annotations')
iterable = x._read(path)
iterator = (x for x in iterable)
samples = []
for x in iterator:
    samples.append(x)
z = 1
